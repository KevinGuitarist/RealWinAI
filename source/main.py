...
frontend_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "realwin-frontend-master", "dist")
...
if os.path.exists(frontend_path):
    ...
    print("⚠️ Frontend build not found. Run 'npm run build' in realwin-frontend-master first.")
