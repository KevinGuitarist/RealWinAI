...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print('  python enhanced_cricket_prediction.py YYYY-MM-DD')
        print('  Example: python enhanced_cricket_prediction.py "2025-01-25"')
        print('')
        print('OPTION 2 - Predict specific team match (legacy):')
        print('  python enhanced_cricket_prediction.py "Team 1" "Team 2" YYYY-MM-DD [venue]')
        print('  Example: python enhanced_cricket_prediction.py "India" "Australia" "2025-01-21" "MCG"')
        print('')
